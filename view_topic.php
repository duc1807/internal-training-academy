    ...
    <div class="row">
        <div class="col m-auto">
            <div class="card mt-5">
                <table class="table table-bordered">
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $TopicExplain ?></td>
                            <td><?php echo $TopicDate ?></td>
                            <td><?php echo $TopicExpired ?></td>
                            <td><a href="edit_topic.php?GetID=<?php echo $TopicID ?>">Edit</a></td>
                            <td><a href="controllers/delete_topic.php?Del=<?php echo $TopicID ?>">Delete</a></td>
                        </tr>
                        <?php
                    }
                    ?>
                ...
                <button onclick="location.href='insert_Topic.php'">Add</button>
            </div>
        </div>
    </div>
</div>
