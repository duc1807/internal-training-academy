                ...
                <ul class="navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="mark_attendance_trainee.php">GCH0705</a>
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="view_topic_trainee.php">GCH0705</a>
                            <a class="dropdown-item" href="">GCH0508</a>
                            <a class="dropdown-item" href="">GCH0809</a>
                        </div>
            ...
            <div class="card mt-5">
                <table class="table table-bordered">
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        $AttendanceID = $row['id'];
                        $RollID = $row['roll_no'];
                        $AttendanceName = $row['student_name'];
                        $AttendanceStatus = $row['attendance_status'];
                        $AttendanceTime = $row['date_created'];
                        ?>
                        <tr>
                            <td><?php echo $AttendanceID ?></td>
                            <td><?php echo $RollID ?></td>
                            <td><?php echo $AttendanceName ?></td>
                            <td><?php echo $AttendanceStatus ?></td>
                            <td><?php echo $AttendanceTime ?></td>
